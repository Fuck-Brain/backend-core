...
namespace Template.Net.Microservice.ThreeTier.PL.Definitions.Identity
{
    /// <summary>
    ...
    public sealed class UserIdentity
    {
        ...
        {
            ContextAccessor = httpContextAccessor ?? throw new ArgumentNullException(nameof(httpContextAccessor));
            IsInitialized = true;
        }
